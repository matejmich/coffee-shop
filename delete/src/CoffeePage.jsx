  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {data.map((product) => (
          <div key={product.id} className=" flex flex-col border border-gray-200 rounded-md p-4">
            ...
            <p className="text-gray-600 mb-4" style={{ minHeight: '6rem' }}>{product.description}</p>
